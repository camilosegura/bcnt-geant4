...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    G4Box *solidWord = new G4Box("solidWorld", 0.2*m, 0.2*m, 0.2*m);
    ...
    // G4double outerRadiusTumor = 100*um;
    G4double outerRadiusTumor = 1*mm;
    ...
    G4VPhysicalVolume *physTumor = new G4PVPlacement(0, G4ThreeVector(0., 0., 110.), logicTumor, "physTumor", logicWorld, false, 0, true);
    

    G4double innerRadiusBrain = 10*um;
